	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'need_call'     => $order_query->row['need_call']
			);
		} else {
			return false;
		}
